...
export const Step5_Final = ({ onNext, previewImage }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto text-center animate-in fade-in duration-1000 px-3 sm:px-0">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif text-gray-900 mb-4 font-semibold">
        Your First Video Is Ready!
      </h1>
      <p className="text-gray-500 text-sm sm:text-base mb-8 sm:mb-10 mx-auto font-medium leading-relaxed">
        Save your memory video and share it with the people you love most —
        these moments are meant to be remembered.
      </p>

      {/* Result Preview */}
      <div className="w-52 h-72 sm:w-64 sm:h-80 mx-auto rounded-[2rem] overflow-hidden mb-8 sm:mb-10 shadow-2xl border-4 border-white">
        <img
          src={
            previewImage ||
      ...
      /> */}
        ...
        <div onClick={() => navigate("/step-login")}>
          <Button className="w-full mb-4 sm:mb-6 py-3 sm:py-4 text-base sm:text-lg">
