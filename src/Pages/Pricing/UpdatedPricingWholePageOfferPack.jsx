...
import OfferPackPricingSection, { plans } from "./OfferPackPricingSection";
...
export default function UpdatedPricingWholePage() {
    const [selected, setSelected] = useState("image_package");
    ...
    const finalAmountUsd = selectedPlan ? priceAmount : 0;
